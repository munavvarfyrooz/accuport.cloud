#!/usr/bin/env python3
"""Fix the data table method - start new page and show all data"""

with open("generate_vessel_report.py", "r") as f:
    content = f.read()

# Replace the add_data_table_with_limits method with fixed version
old_method = '''    def add_data_table_with_limits(self, data, equipment_type, params_list, title=None):
        """
...
print("Fixed add_data_table_with_limits method")
